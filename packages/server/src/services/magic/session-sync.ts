...
import { createSession, addMessage, updateSession } from '../../db/magic/session-store'
import { getDb } from '../../db/index'
import { logger } from '../logger'
import { listSessionSummaries as listHermesSessionSummaries } from '../../db/magic/sessions-db'
  ...
  try {
    ...
    for (const hermesSession of summaries) {
      ...
      try {
        ...
        const { getSessionDetailFromDbWithProfile } = await import('../../db/magic/sessions-db')
