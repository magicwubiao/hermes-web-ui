...
import {
  ...
  isSensitivePath,
  MAX_EDIT_SIZE,
} from '../../services/magic/file-provider'
...
// GET /api/magic/files/list?path=
fileRoutes.get('/api/magic/files/list', async (ctx) => {
...
// GET /api/magic/files/stat?path=
fileRoutes.get('/api/magic/files/stat', async (ctx) => {
  const relativePath = ctx.query.path as string
  if (!relativePath) {
    ctx.status = 400
...
// GET /api/magic/files/read?path=
fileRoutes.get('/api/magic/files/read', async (ctx) => {
  const relativePath = ctx.query.path as string
  if (!relativePath) {
    ctx.status = 400
    ctx.body = { error: 'Missing path parameter', code: 'missing_path' }
...
// PUT /api/magic/files/write  body: { path, content }
fileRoutes.put('/api/magic/files/write', async (ctx) => {
...
// DELETE /api/magic/files/delete  body: { path, recursive? }
fileRoutes.delete('/api/magic/files/delete', async (ctx) => {
...
// POST /api/magic/files/rename  body: { oldPath, newPath }
fileRoutes.post('/api/magic/files/rename', async (ctx) => {
...
// POST /api/magic/files/mkdir  body: { path }
fileRoutes.post('/api/magic/files/mkdir', async (ctx) => {
...
// POST /api/magic/files/copy  body: { srcPath, destPath }
fileRoutes.post('/api/magic/files/copy', async (ctx) => {
...
// POST /api/magic/files/upload?path=  (multipart/form-data)
fileRoutes.post('/api/magic/files/upload', async (ctx) => {
